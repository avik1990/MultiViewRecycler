...
public class ItemFragment extends Fragment {
    ...
    private int[] imageArray = new int[]{R.drawable.back_img, R.drawable.back_img,
            R.drawable.back_img, R.drawable.back_img, R.drawable.back_img,
            R.drawable.back_img, R.drawable.back_img, R.drawable.back_img,
            R.drawable.back_img, R.drawable.back_img};

    public static Fragment newInstance(MainCrouselActivity context, int pos, float scale) {
        Bundle b = new Bundle();
